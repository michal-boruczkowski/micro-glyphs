...
export const NICE_FULL_SET = [FULL_3x3, SQUARE_3x3, DOT_3x3, CROSS_3x3]

export const TOP_LEFT_SET = [BIRD_TOP_LEFT_3x3, L_TOP_LEFT_3x3]
export const TOP_RIGHT_SET = [BIRD_TOP_RIGHT_3x3, L_TOP_RIGHT_3x3]
export const BOTTOM_LEFT_SET = [BIRD_BOTTOM_LEFT_3x3, L_3x3]
export const BOTTOM_RIGHT_SET = [BIRD_BOTTOM_RIGHT_3x3, L_BOTTOM_RIGHT_3x3]