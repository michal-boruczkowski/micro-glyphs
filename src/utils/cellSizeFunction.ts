...
export function equalCellSizeFunction(
  canvas: Rectangle,
  howManyRows: number,
  ...
  return (rowIndex: number, columnIndex: number) =>
    new Rectangle(0, 0, equalColumnSize, equalRowSize);
}

export function geometricalCellSizeFunction(
  canvas: Rectangle,
  howManyRows: number,
  howManyColumns: number,
): CellSizeFunction {
  ...
  return (rowIndex: number, columnIndex: number) =>
    new Rectangle(0, 0, columnSequence[columnIndex], rowSequence[rowIndex]);
}
